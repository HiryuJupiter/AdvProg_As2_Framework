...
namespace HiryuTK.TopDownController
{
    public class Module_Move : ModuleBase
    {
        ...
        {
            status.velocity.z = Mathf.Lerp(status.velocity.z, 
                GameInput_TopDownController.MoveZ * settings.MoveSpeed, 
                Time.deltaTime * settings.AccelerationSpeed);
        ...
        bool HasVerticalInput => (GameInput_TopDownController.MoveZ > 0.1f || 
            GameInput_TopDownController.MoveZ < -0.1f);
